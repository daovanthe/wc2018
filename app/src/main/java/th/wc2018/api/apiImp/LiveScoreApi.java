...
public class LiveScoreApi extends API {

    private static final String LINK = "http://livescore-api.com/api-client/scores/live.json?";

    public LiveScoreApi(String key, String secret, String[] legue1) {
...
//        String data = getJsonStringFromLinkAPI(link);
        String scoreData = "{ \"success\": true, \"data\": { \"match\": [ " +
                "{ \"id\": \"14\", \"home_name\": \"Russia\", \"away_name\": \"Japan\", \"score\": \"0 - 0\", \"ht_score\": \"0 - 0\", \"ft_score\": \"\", \"et_score\": \"\", \"time\": \"36\", \"league_id\": \"90\", \"status\": \"IN PLAY\", \"added\": \"2017-11-16 00:40:21\", \"last_changed\": \"2017-11-16 00:40:21\", \"home_id\": \"0\", \"away_id\": \"188\", \"events\": true, \"league_name\": \"Liga Nacional:: apertura\" }, " +
                "{ \"id\": \"15\", \"home_name\": \"Germany\", \"away_name\": \"Japan\", \"score\": \"1 - 0\", \"ht_score\": \"0 - 0\", \"ft_score\": \"\", \"et_score\": \"\", \"time\": \"36\", \"league_id\": \"90\", \"status\": \"IN PLAY\", \"added\": \"2017-11-16 00:40:21\", \"last_changed\": \"2017-11-16 00:40:21\", \"home_id\": \"0\", \"away_id\": \"188\", \"events\": true, \"league_name\": \"Liga Nacional:: apertura\" }, " +
                "{ \"id\": \"16\", \"home_name\": \"Russia\", \"away_name\": \"Japan\", \"score\": \"0 - 0\", \"ht_score\": \"0 - 0\", \"ft_score\": \"\", \"et_score\": \"\", \"time\": \"36\", \"league_id\": \"90\", \"status\": \"IN PLAY\", \"added\": \"2017-11-16 00:40:21\", \"last_changed\": \"2017-11-16 00:40:21\", \"home_id\": \"0\", \"away_id\": \"188\", \"events\": true, \"league_name\": \"Liga Nacional:: apertura\" }, " +
                "{ \"id\": \"17\", \"home_name\": \"Spain\", \"away_name\": \"England\", \"score\": \"1 - 0\", \"ht_score\": \"0 - 0\", \"ft_score\": \"\", \"et_score\": \"\", \"time\": \"36\", \"league_id\": \"90\", \"status\": \"IN PLAY\", \"added\": \"2017-11-16 00:40:21\", \"last_changed\": \"2017-11-16 00:40:21\", \"home_id\": \"0\", \"away_id\": \"188\", \"events\": true, \"league_name\": \"Liga Nacional:: apertura\" }, " +
                "{ \"id\": \"18\", \"home_name\": \"Spain\", \"away_name\": \"Australia\", \"score\": \"2 - 1\", \"ht_score\": \"\", \"ft_score\": \"\", \"et_score\": \"\", \"time\": \"23:45\", \"league_id\": \"21\", \"status\": \"NOT STARTED\", \"added\": \"2017-11-16 00:40:21\", \"last_changed\": \"2017-11-16 00:40:21\", \"home_id\": \"265\", \"away_id\": \"269\", \"events\": \"http://livescore-api.com/api-client/scores/events.json?key=vA4yJ0A9MNe0bu5b&secret=xDeXXO0pK2rCmhDSSIqCI1LuO0vZuBb2&id=9\", \"league_name\": \"Serie A\" " +
                "} ] } }";
...
//        String jsonArrayFixtures = subArgs.getAsString();
        try {
            ...
            LiveScore[] liveLiveScore = gson.fromJson(subArgs.toString(), LiveScore[].class);
            // add to database


            for (LiveScore match : liveLiveScore) {
                if (!match.getEvents().equals("false")) {
...
//                    String eventDataString = getJsonStringFromLinkAPI(Event);
    ...
    public void AddLoadLiveScoreEvent(ILoadLiveScoreEvent pLoadLiveScoreEvent) {
        this.mILoadLiveScoreEvent = pLoadLiveScoreEvent;
    }

    public interface ILoadLiveScoreEvent {
        void loadEventCompleted(Events[] liveLiveScoreEvent);
    }
